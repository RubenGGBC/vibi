# Vibi PWA Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Entregar una PWA móvil-first servida por Vibi, con autenticación, API REST, eventos en vivo, integración compartida con Telegram y despliegue en un único contenedor.
...
**Files:**
- Create: `frontend/public/vibi-icon.svg`
...
**Interfaces:**
- Produces: manifest `Vibi`, standalone dark theme, generated service worker, static asset serving and `index.html` fallback for client-side routes.
...
- [ ] **Step 5: Convert Dockerfile to Node-build + Python-runtime stages** and copy `frontend/dist` into `/srv/vibi/frontend/dist`.
